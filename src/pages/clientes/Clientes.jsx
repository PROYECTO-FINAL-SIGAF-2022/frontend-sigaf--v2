            ...
            <div className="row">
              <div class="col-lg-10 mx-auto mb-4">
                <div class="section-title text-center ">
                  <h3 class="top-c-sep">LISTA DE CLIENTES/PROVEEDORES</h3>
                  ...
                  <div className="filter-result">
                    ...
                    <div className="d-md-flex text-capitalize">
                        <Link to="/Formulario-proveedor" className="menu-link">
                            <button className="btn btn-infobtn  btn-outline-info " >Agregar Nuevo Cliente</button>
                        </Link>
                    </div>
                    <br></br>
                    {!fetchData ? (
                        ...
                        fetchData.map(item => { 
                            return(
                                ...
                                <div className="job-left my-4 d-md-flex align-items-center flex-wrap">
                                  ...
                                  {/* Modo Ejemplo */}
                                  {item?.nombre_proveedor[0]}{item?.nombre_proveedor[10]}
                                  </div>
                                  <div className="job-content">
                                    ...
                                    <ul className="d-md-flex text-capitalize ff-open-sans">
                                      <li className="mr-md-4 mx-3">
                                        <i className="zmdi zmdi-pin mr-2"></i> {item?.direccion_proveedor}
                                      </li>
          
                                      <li className="mr-md-4">
                                        <i className="zmdi zmdi-smartphone mr-2"></i> +54
                                ...
                                <div className="d-md-flex text-capitalize ff-open-sans">
                                  ...
                                  <button className="btn  d-block w-100 btn-danger">
                                    Eliminar
                                  </button>
                                </div>
                              </div>           
