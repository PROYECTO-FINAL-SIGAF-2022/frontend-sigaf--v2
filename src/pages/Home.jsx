                    ...
                    <div className="d-flex align-items-end row">
                      <div className="col-sm-7">
                        <div className="card-body">
                          <h5 className="card-title text-primary">SISTEMA DE GESTION AGROPECUARIA FORMOSEÑA! 🎉</h5>
                          <p className="mb-4">
                            Nuestros usuarios estan un <span className="fw-bold">72%</span> conformes con nuestra aplicacion de gestion Dea
                          </p>

                          <a href="javascript:;" className="btn btn-sm btn-outline-primary">Ver Mas</a>
                        </div>
                      </div>
